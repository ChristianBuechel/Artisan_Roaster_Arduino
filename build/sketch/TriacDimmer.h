#line 1 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\TriacDimmer.h"
/**
 *	@file	TriacDimmer.h
 *	@brief	Contains header information for the TriacDimmer library.
 *	@author	Christian Büchel modified from Anson Mansfield 2017-02-23
 *	@date 	2025-05-06
 */
...
#define RATIO_M 100  
#define ZC_LEAD 1000 //500us time from negative slope of ZC until actual ZC
#define ICC_PIN 7    //D7 or PD7
/**
...
namespace TriacDimmer
{
	...
	void setDuty(uint8_t pin, uint8_t value);
	/**
	...
	/**
	 *	@brief	returns mains period in timer ticks
	 *	This method returns the mains period in timer ticks.
	 */
	...
	namespace detail
	{
        ...
        void setChannelA_direct(uint16_t value);

        void setChannelB_direct(uint16_t value);
