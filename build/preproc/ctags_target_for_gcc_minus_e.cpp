# 1 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino"
# 2 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 3 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 4 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 5 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 6 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 7 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
# 8 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 2
...
cADC adc(0x68); // MCP3424 using the default of A4(SDA), A5(SCL)

TypeK tc[2]; // array of pointers to thermocouples
...
void process_FAN()
{
 ...
 if (arg != 
# 38 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 3 4
           __null
# 38 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino"
               ) // As long as it exists, take it
 {
  d = atol(arg);
  d_fl = ((d)<(0)?(0):((d)>(100)?(100):(d)));
  d_int = ((d)<(0)?(0):((d)>(100)?(100):(d)));
  // TriacDimmer::setBrightness(FAN_PIN, d_fl/100);
  TriacDimmer::setDuty(10 /*Triac output for fan*/, d_int);
  fan = d_int;
 }
}
...
void process_PWR()
{
 ...
 arg = myCMD.next(); // Get the next argument from the SerialCommand object buffer
 if (arg != 
# 55 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 3 4
           __null
# 55 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino"
               ) // As long as it exists, take it
 {
  d = atol(arg);
  d_in = ((d)<(0)?(0):((d)>(100)?(100):(d)));
...
void process_CHAN()
{
 ...
 if (arg != 
# 87 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino" 3 4
           __null
# 87 "C:\\Users\\buechel\\HiDrive\\privat\\Arduino\\Artisan_Roaster_Arduino\\Artisan_Roaster_Arduino.ino"
...
void setup()
{
 ...
 TriacDimmer::setBrightness(10 /*Triac output for fan*/, 0);
 TriacDimmer::setBrightness(9 /*Triac output for heater*/, 0);
...
void loop()
{
 ...
 { // one-shot conversions on both chips
  ...
  delay(300 /* ms between ADC samples (tested OK at 270)*/); // wait for conversion to finish
